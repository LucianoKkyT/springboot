...
public class ClienteBOTest {
	...
	public void insere() {
		...
		cliente.setCpf("23095928531");
		cliente.setDataDeNascimento(LocalDate.of(2000, 1, 8));
		cliente.setSexo(Sexo.MASCULINO);
		cliente.setTelefone("1130647901");
		cliente.setTelefone("11981074698");
		cliente.setAtivo(true);
		cliente.setEmail("luciano@email.com.br");
		bo.insere(cliente);
	}
